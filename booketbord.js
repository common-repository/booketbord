...
function openwsylightbox(href){
	...
	var wsy_query_append = '';
	var wsy_url = new URL(location.href);
	wsy_url.searchParams.forEach(function(val,key){
		wsy_query_append += '&'+key+'='+encodeURIComponent(val);
	});
	if(window.mobilecheck()){
		top.document.location.href = href + wsy_query_append;
	} else {
		document.getElementById('wsylightbox-iframe').src = href + wsy_query_append
